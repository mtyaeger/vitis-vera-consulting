    ...
    <footer className="noise bg-ink text-paper">
      <div className="site-shell py-16 md:py-20">
        <div className="grid gap-12 border-b border-paper/15 pb-14 md:grid-cols-[1.3fr_0.7fr] md:items-end">
          <div><BrandMark inverse /><p className="mt-7 max-w-lg text-sm leading-7 text-paper/65">Custom business systems that buy back time and improve decision-making. Built around how your business actually works.</p></div>
